...
// Note: This class is probably stupid and is replacable by std::vector.
// The only reason it exists is because I couldn't find documentation at the
// time that guarantees a std::vector stores its data in a contiguous chunk ofxi
// memory.  But, you know, it does.
